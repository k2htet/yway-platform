...
| Experiment structure and outcome           | YWAY-P002, YWAY-P003            | Identified experiments have six parts; meaningful completion includes realistic task, noticing, reflection, and next fork; a started next action remains distinct from an option selected; self-report does not become verified evidence |
